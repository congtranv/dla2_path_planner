...
private:
    ...
    // congtranv
    ros::Subscriber current_3d_position_sub;
    ros::Subscriber goal_3d_position_sub;
    ...
    // congtranv
    void current3DPositionCallback(const geometry_msgs::Point::ConstPtr& msg);
    void goal3DPositionCallback(const geometry_msgs::Point::ConstPtr& msg);
